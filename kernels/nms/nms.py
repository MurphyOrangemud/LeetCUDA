...
for nboxes in Nboxes:
    ...
    run_benchmark(lib.nms_origin, boxes, scores, thresholds, "nms_origin")
    run_benchmark(lib.nms_optim_1d, boxes, scores, thresholds, "nms_optim_1d")
    run_benchmark(lib.nms_2d, boxes, scores, thresholds, "nms_2d")
